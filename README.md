...
### Install
```
npm install @chainplatform/react-native-htmlview --save
```
or
```
yarn add @chainplatform/react-native-htmlview
```
...
- `imageWidth`: Image render size, height will auto calculator from original size
...
- `NodeComponent`, `nodeComponentProps`, `RootComponent`, `rootComponentProps`, `TextComponent`, `textComponentProps`: see [**Customizing things even further**](https://github.com/ChainPlatform/react-native-htmlview#customizing-things-even-further) below.
...
import HTMLView from '@chainplatform/react-native-htmlview';

class App extends React.Component {
  render() {
    const htmlContent = `<p><a href="http://google.com">&hearts; nice job!</a></p>`;
